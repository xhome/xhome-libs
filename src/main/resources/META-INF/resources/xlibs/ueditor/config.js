...
(function () {
    ...
    var pos = URL.indexOf('xlibs/ueditor');
    var BASE_URL = URL, UPLOAD_BASE_URL = URL, UPLOAD_PATH = URL; 
    if (pos > 0) {
        BASE_URL = URL.substr(0, pos);
        UPLOAD_BASE_URL = BASE_URL + 'xfileupload/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,fileUrl: UPLOAD_BASE_URL + 'ue_file.htm'
        ...
        ,catcherUrl: UPLOAD_BASE_URL + 'ue_get_remote_image.htm' 
        ,catcherPath: UPLOAD_PATH

        //图片在线管理配置区
        // ,imageManagerUrl:URL + "jsp/imageManager.jsp"       //图片在线管理的处理地址
        // ,imageManagerPath:URL + "jsp/"                                    //图片修正地址，同imagePath
        ,imageManagerPath: UPLOAD_PATH
        ,imageManagerUrl: UPLOAD_BASE_URL + 'ue_image_manager.htm'
        ...
        ,snapscreenServerUrl: UPLOAD_BASE_URL + 'ue_image.htm'
        ,snapscreenPath: UPLOAD_PATH

        //word转存配置区
        // ,wordImageUrl:URL + "jsp/imageUp.jsp"             //word转存提交地址
        // ,wordImagePath:URL + "jsp/"                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数
        ,wordImageUrl: UPLOAD_BASE_URL + 'ue_image.htm' 
        ...
        ,getMovieUrl: UPLOAD_BASE_URL + 'ue_get_movie.htm' 
        ,videoUrl: UPLOAD_BASE_URL + 'ue_file.htm'
        ,videoPath: UPLOAD_PATH
